(function($) {
    ...
    function goToNextSlide(slideOut, slideIn) {
        ...
        if (slideIn.length !== 0) {
            ...
            tl
                .set(slideIn, { width: '0px', right: '0px', left: '', autoAlpha: 1, className: '+=active' })
                .set(slideOut, { className: '-=active' })
                .to(slideIn, 1, { width: '100%', left: '0px', right: '', ease: Power3.easeInOut }, 0.5)
                .to(slideOut, 1, { width: '0px', left: '0px', right: '', ease: Power3.easeInOut }, 0);
        };
    }
    ...
    next.click(function(e) {
        ...
        var slideOut = $('.box.active'),
            slideIn = $('.box.active').next('.box'),
            slideOutText = $('.text.active'),
            slideInText = $('.text.active').next('.text');;
    ...
    function goToPrevSlide(slideOut, slideIn) {
        ...
        if (slideIn.length !== 0) {
            tl
                .set(slideIn, { width: '0px', left: '0px', right: '', autoAlpha: 1, className: '+=active' })
                .set(slideOut, { className: '-=active' })
                .to(slideIn, 1, { width: '100%', right: '0px', left: '', ease: Power3.easeInOut }, 0.5)
                .to(slideOut, 1, { width: '0px', right: '0px', left: '', ease: Power3.easeInOut }, 0);
        };
    }
    ...
    prev.click(function(e) {
        ...
        var slideOut = $('.box.active'),
            slideIn = $('.box.active').prev('.box'),
            slideOutText = $('.text.active'),
            slideInText = $('.text.active').prev('.text');;
